...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "
        SELECT Sections.section_number, Sections.classroom, Sections.meeting_days, Sections.start_time, Sections.end_time, 
               COUNT(Enrollments.student_campus_id) AS num_students_enrolled
        FROM Sections
