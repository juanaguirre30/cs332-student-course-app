...
<h2 style="text-align: center;">Grade Distribution for Course <?php echo $course_number; ?>, Section Number: <?php echo $section_number; ?></h2>

<?php if ($result): ?>
  <?php foreach ($result as $row): ?>
    <div><?php echo "Grade: " . $row['grade'] . " - Student Count: " . $row['student_count']; ?></div>
  <?php endforeach; ?>
<?php endif; ?>
